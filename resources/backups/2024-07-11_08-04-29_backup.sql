...
INSERT INTO `sessions` VALUES ('7MLg5Dgr0P5orRI3N1G5AqqP0gzYdm7YamTrtrnQ',2,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36','',1720525597),('HUOvhEvVLjpAEYQHXwhDykHei5O0sIbJhCxtFH4n',2,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36','',1720597376),('sWEJHoc9Mwg2plE05EeK8JWWxZ0fMXFNGnRcMT9C',2,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36','',1720685066);
...
INSERT INTO `tbl_company` VALUES (1,'Geek Bar 15K company','51651354621','some texts',50,'Completed','Cash','2024-07-09 03:08:07','2024-07-09 03:08:07'),(2,'META BAR Company','45646541321654','sakdhahskld alkjsdlk jaslk',50,'Undre Process','Check','2024-07-09 03:08:55','2024-07-09 03:08:55'),(3,'META BAR 2 Company','455556546','asdasdas',100,'Completed','ZELLE','2024-07-09 03:09:15','2024-07-09 03:09:15');
...
INSERT INTO `tbl_customer` VALUES (1,'Alex','Bronox NY',160,'54412165','2024-07-10 02:48:03','2024-07-09 03:12:05'),(2,'Kiven','Kabul',620,'446544','2024-07-10 03:12:53','2024-07-09 03:12:25');
...
INSERT INTO `tbl_orderdetail` VALUES (2,10,5,2,2,'2024-07-08'),(13,20,5,7,3,'2024-07-10');
...
INSERT INTO `tbl_orders` VALUES (2,'.','2024-07-09',1,'2024-07-09 03:14:45','2024-07-09 03:14:45'),(7,'.','2024-07-10',2,'2024-07-10 03:12:53','2024-07-10 03:12:53');
...
INSERT INTO `tbl_payment` VALUES (10,0,100,'N/A','Unpaid','2024-07-10',7,2,'2024-07-10 07:42:53.000000','2024-07-10 07:42:53');
...
INSERT INTO `tbl_product` VALUES (1,'Geek Bar 15K',NULL,10,5,'In Stock','2024-07-09',NULL,'2024-07-09 03:06:42','2024-07-09 03:06:42'),(2,'META BAR',NULL,10,5,'In Stock','2024-07-09',NULL,'2024-07-09 03:07:02','2024-07-09 03:07:02'),(3,'Geek Bar 2',NULL,10,10,'In Stock','2024-07-09',NULL,'2024-07-09 03:07:22','2024-07-09 03:07:22');
...
CREATE TABLE `tbl_refund` (
  ...
  `Customer_ID` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `tbl_refund_order_id_foreign` (`Order_ID`),
  KEY `tbl_refund_customer_id_foreign` (`Customer_ID`),
  CONSTRAINT `tbl_refund_customer_id_foreign` FOREIGN KEY (`Customer_ID`) REFERENCES `tbl_customer` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tbl_refund_order_id_foreign` FOREIGN KEY (`Order_ID`) REFERENCES `tbl_orders` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-07-11 16:04:30
