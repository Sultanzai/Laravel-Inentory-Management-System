    ...
    <div class="dashboard">
      <div class="div">
        <div class="list">
          ...
          <div class="list-2">
            ...
            <div class="task">
              ...
              <div class="pill">
                <div class="tag"><div class="label-2">$1500</div></div>
              </div>
              <div class="text-wrapper-12">Paid</div>
              <div class="text-wrapper-13">Shipped</div>
              <div class="text-wrapper-14">5/20/2024</div>
            ...
            <div class="task">
              <div class="text-wrapper-9">1</div>
              <div class="text-wrapper-10">Alex</div>
              <div class="text-wrapper-11">Vape ABC</div>
              <div class="pill">
                <div class="tag"><div class="label-2">$2500</div></div>
              </div>
              <div class="text-wrapper-12">Paid</div>
              <div class="text-wrapper-13">Shipped</div>
              <div class="text-wrapper-14">5/20/2024</div>
            ...
            <div class="task">
              <div class="text-wrapper-9">1</div>
              <div class="text-wrapper-10">Alex</div>
              <div class="text-wrapper-11">Vape RGB</div>
              <div class="pill">
                <div class="tag"><div class="label-2">$3000</div></div>
              </div>
              <div class="text-wrapper-12">Paid</div>
              <div class="text-wrapper-13">Shipped</div>
              <div class="text-wrapper-14">5/20/2024</div>
            ...
            <div class="task">
              ...
              <div class="text-wrapper-11">Halo Pro V5</div>
              <div class="pill">
                <div class="tag"><div class="label-2">$4500</div></div>
              </div>
              <div class="text-wrapper-12">Paid</div>
              <div class="text-wrapper-13">Shipped</div>
              <div class="text-wrapper-14">5/20/2024</div>
        ...
        <div class="segmented-control">
          <a href=""><button class="btn2" >Products</button></a>
